...
contract CeloEthBridge {
    ...
    // Event emitted when tokens are bridged from Celo to Ethereum
    ...
    // Function to bridge tokens from Celo to Ethereum
    ...
    // Function to bridge tokens from Ethereum to Celo
